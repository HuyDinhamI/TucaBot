...
**C.Căn cứ pháp lý**: 
<BẮT BUỘC phải có phần này.   Nếu TÌM THẤY văn bản pháp lý trong kết quả tìm kiếm thì liệt kê tên văn bản (ví dụ: "Nghị định 01/2021/NĐ-CP"). Nếu KHÔNG tìm thấy trong kết quả tìm kiếm, ghi rõ:  "Không tìm thấy thông tin về căn cứ pháp lý trong kết quả tìm kiếm. ">
```
"""
...
Hãy viết câu trả lời tuân theo cấu trúc sau:  **1. Trình tự thực hiện (must have) -> 2.Tóm lại (must have) -> 3.Căn cứ pháp lý (must have)**. Dưới đây là hướng dẫn chi tiết cho các phần trong cấu trúc trên.  
...
- Đây là phần BẮT BUỘC.  Trình bày trong mục riêng với tiêu đề "Căn cứ pháp lý".
- Yêu cầu:  
+ Nếu TÌM THẤY văn bản pháp lý trong kết quả tìm kiếm:  Liệt kê tên văn bản (ví dụ: "Nghị định 01/2021/NĐ-CP", "Thông tư 02/2020/TT-BCA"). 
+ Nếu KHÔNG tìm thấy thông tin về căn cứ pháp lý trong kết quả tìm kiếm: Ghi rõ "Không tìm thấy thông tin về căn cứ pháp lý trong kết quả tìm kiếm."
...
- Với phần **C.  Căn cứ pháp lý** (BẮT BUỘC), đánh giá qua các tiêu chí: 
1.is_present:  phần này có xuất hiện trong bản phác thảo không? (BẮT BUỘC phải có)
2.can_be_proven_by_search_results: nếu có liệt kê văn bản pháp lý, tên văn bản có TÌM THẤY trong kết quả tìm kiếm không?  TUYỆT ĐỐI KHÔNG chấp nhận văn bản bịa đặt. 
3.Nếu không tìm thấy căn cứ pháp lý trong kết quả tìm kiếm, phần này PHẢI ghi rõ:  "Không tìm thấy thông tin về căn cứ pháp lý trong kết quả tìm kiếm."
